...
public class AliSendSMSTool {

    public static final String product = "Dysmsapi";
    public static final String domain = "dysmsapi.aliyuncs.com";

    
    public static JSON sendSms(String accessKey, String secretKey, String signName, String smsTemp, String phone, String content) throws ClientException {
